...
CATEGORY_KEYWORDS_WEIGHTED = {
    ...
    'sports': {
        'high': [
            'nba', 'nfl', 'mlb', 'nhl', 'fifa', 'world cup', 'olympics', 'championship',
            'super bowl', 'stanley cup', 'world series', 'march madness',
            'baseball', 'basketball', 'football', 'hockey', 'soccer', 'tennis', 'golf',
            'pga', 'the masters', 'open championship', 'uefa', 'premier league',
            'champions league',
        ],
        'medium': [
            'playoffs', 'tournament', 'athlete', 'quarterback', 'goalkeeper', 'coach',
            'pitcher', 'batter', 'home run', 'touchdown', 'goal', 'hat trick',
            'draft', 'free agent', 'trade', 'contract', 'roster', 'lineup',
            'starting', 'bench', 'injury', 'comeback', 'retirement', 'suspension',
            'mvp', 'all-star', 'pro bowl',
            'yankees', 'dodgers', 'red sox', 'cubs', 'mets', 'cardinals',
            'lakers', 'warriors', 'celtics', 'bulls', 'knicks', 'heat', 'spurs',
            'cowboys', 'packers', 'steelers', 'patriots', 'chiefs', 'eagles', '49ers',
            'ravens', 'bills', 'jets', 'dolphins', 'saints', 'panthers', 'falcons',
            'rangers', 'bruins', 'blackhawks', 'maple leafs', 'canadiens', 'penguins',
        ],
        'low': [
            'game', 'match', 'score', 'team', 'league', 'season', 'win', 'loss',
            'victory', 'defeat', 'player', 'star', 'veteran', 'rookie',
            'rumor', 'speculation', 'outlook', 'preview', 'recap',
            'schedule', 'release', 'video', 'highlight',
        ],
    },
    'united-states': {
