        ...
        topics = [
            {
                ...
                'keywords': ['iran', 'strait of hormuz', 'us strikes', 'oil price', 'hormuz', 'irgc', 'central command', 'centcom', 'blockade', 'naval', 'missile', 'nuclear', 'rubio', 'pezeshkian', 'khamenei', 'houthis', 'saudi arabia', 'kuwait', 'bahrain', 'jordan', 'oman', 'uae', 'araghchi', 'ghalibaf', 'ceasefire', 'mou'],
            ...
            },
            {
                ...
                'keywords': ['china', 'xi jinping', 'trade war', 'tariff', 'beijing', 'us-china', 'bilateral', 'taiwan', 'indo-pacific', 'sanctions', 'semiconductor', 'chip', 'ai race', 'north korea', 'kim jong un', 'south korea'],
            ...
            },
            {
                ...
                'keywords': ['israel', 'gaza', 'palestine', 'hamas', 'lebanon', 'hezbollah', 'west bank', 'ceasefire', 'hostage', 'rafah', 'humanitarian', 'unrwa', 'syria', 'yemen', 'houthi', 'saudi', 'uae', 'oman', 'qatar'],
